            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="{{ url('/pacientes') }}" class="btn btn-sm btn-succes">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('/pacientes/'.$patient->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-warning">Solo rellene el campo si desea cambiar la contraseña</small>
                    </div>
                    <button type="submit" clas="btn btn-sm btn-primary">Guardar cambios</button>
                </form>
            </div>
